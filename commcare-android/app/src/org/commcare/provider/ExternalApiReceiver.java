        ...
        DataPullTask<Object> mDataPullTask = new DataPullTask<Object>(
            ...
            protected void deliverResult(Object receiver, ResultAndError<PullTaskResult> resultAndErrorMessage) {
                ...
                if (result != PullTaskResult.DOWNLOAD_SUCCESS) {
                    Toast.makeText(context, "Collectra couldn't sync. Please try to sync from Collectra directly for more information", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(context, "Collectra synced!", Toast.LENGTH_LONG).show();
                }
            }
