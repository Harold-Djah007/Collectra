            ...
            protected void deliverResult(FormRecordListActivity receiver, ResultAndError<PullTaskResult> statusAndErrorMessage) {
                ...
                switch (status) {
                    ...
                    case CONNECTION_TIMEOUT:
                        ...
                        break;
                    case SERVER_ERROR:
                        Toast.makeText(receiver, "The server had an error processing your data. Please try again later, and contact Collectra Support if the problem persists.", Toast.LENGTH_LONG).show();
                        break;
                    case RATE_LIMITED_SERVER_ERROR:
                        Toast.makeText(receiver, "Our servers are unavailable at this time. Please try again later, and contact Collectra Support if the problem persists.", Toast.LENGTH_LONG).show();
                        break;
