...
public class AndroidShortcuts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (Intent.ACTION_CREATE_SHORTCUT.equals(action)) {
            if (CommCareApplication.instance().getCurrentApp() == null) {
                Toast.makeText(this, "Please install a Collectra app first.", Toast.LENGTH_LONG).show();
    ...
    private void buildMenuList() {
        final PaneledChoiceDialog dialog = new PaneledChoiceDialog(this, "Select Collectra Shortcut");
