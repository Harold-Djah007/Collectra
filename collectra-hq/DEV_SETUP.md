...
### Collectra local static/i18n assets

After changing Collectra branding or frontend assets, regenerate Django's JavaScript
translation catalog and collected static files before opening the site:
