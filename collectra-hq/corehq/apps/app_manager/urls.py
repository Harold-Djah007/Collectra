...
app_urls = [
    ...
    url(r'^import/xlsform/$', xlsform_import, name='xlsform_import'),
...
urlpatterns = [
    ...
    url(r'^form_builder/$', form_builder_choice, name='form_builder_choice'),
    url(r'^form_builder/excel/$', excel_form_builder, name='excel_form_builder'),
