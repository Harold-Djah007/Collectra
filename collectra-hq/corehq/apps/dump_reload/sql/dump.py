...
[APP_LABELS_WITH_FILTER_KWARGS_TO_DUMP[iterator.model_label].append(iterator) for iterator in [
    ...
    FilteredModelIteratorBuilder('data_cleaning.BulkEditChange', SimpleFilter('session__domain')),
    ...
    FilteredModelIteratorBuilder('app_manager.AppInstallCode', SimpleFilter('domain')),
    ...
    FilteredModelIteratorBuilder('case_search.CaseSearchEndpoint', SimpleFilter('domain')),
    FilteredModelIteratorBuilder('case_search.CaseSearchEndpointVersion', SimpleFilter('endpoint__domain')),
